...
public class InputProcessorUtil {
	...
	public static CheckpointBarrierHandler createCheckpointBarrierHandler(
		...
		return new CausalBufferHandler(checkpointedTask, checkpointedTask.getJobCausalLog(), checkpointedTask.getRecoveryManager(), barrierHandler, inputGate.getNumberOfInputChannels(), checkpointedTask.getCheckpointLock());
	}
}
