...
public class VertexCausalLogTests {
	...
	//	CausalLog log = new CoarseGrainedLockingCircularCausalLog(1, new VertexId((short) 0));
	...
	//	CausalLog log = new CoarseGrainedLockingCircularCausalLog(2, new VertexId((short) 0));
	...
	//	CausalLog log = new CoarseGrainedLockingCircularCausalLog(3, trackedVertex);
	//	InputChannelID downstreamConsumer = new InputChannelID();
	//	log.registerDownstreamConsumer(downstreamConsumer);
	...
	//	CausalLog src = new CoarseGrainedLockingCircularCausalLog(trackedVertex);
	...
	//	VertexId trackedVertex = new VertexId((short) 0);
	//	CausalLog log = new CoarseGrainedLockingCircularCausalLog(2, trackedVertex);
	...
	//	CausalLog log = new CoarseGrainedLockingCircularCausalLog(1024, new VertexId((short) 0));
