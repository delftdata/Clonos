...
public class CheckpointCoordinator {
	...
	public CheckpointTriggerResult triggerCheckpoint(
		...
		for (int i = 0; i < tasksToTrigger.length; i++) {
			...
			if (ee == null) {
				LOG.info("Checkpoint triggering task {} of job {} is not being executed at the moment. Aborting " +
						"checkpoint.",
				...
				LOG.info("Checkpoint triggering task {} of job {} is not in state {} but {} instead. Aborting " +
						"checkpoint.",
					tasksToTrigger[i].getTaskNameWithSubtaskIndex(),
					job,
					...
					executor.execute(new Runnable() {
						...
						public void run() {
							try {
								...
								LOG.warn("Could not properly discard completed checkpoint {} of job {}.",
