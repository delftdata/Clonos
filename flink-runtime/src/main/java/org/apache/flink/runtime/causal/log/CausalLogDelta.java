...
public class CausalLogDelta {
	...
	public CausalLogDelta(VertexId vertexId, ByteBuf rawDeterminants, int offsetFromEpoch) {
		this(vertexId, offsetFromEpoch);
		this.rawDeterminants = rawDeterminants;
	}

	public CausalLogDelta(VertexId vertexId,  int offsetFromEpoch) {
	...
	public boolean equals(Object o) {
		...
		return getOffsetFromEpoch() == that.getOffsetFromEpoch() &&
			...
			getRawDeterminants().equals(that.getRawDeterminants());
	}

	@Override
	public int hashCode() {
		int result = Objects.hash(getVertexId(), getOffsetFromEpoch());
		result = 31 * result + rawDeterminants.hashCode();
		return result;
	}
